...
{
    public class AestheticPipe : IPipe
    {
        Rectangle sourceRectangle;
        int spriteHeight = 130;
        int spriteWidthTop = 14;
        ...
        public AestheticPipe(Vector2 initLocation, bool isWarp, String fn, Vector2 marioSpawn)
        {
            location = initLocation;
            filename = fn;
            spawnLoc = marioSpawn;
            isWarpPipe = false;
            sourceRectangle = new Rectangle(118, 322, spriteWidthTop, spriteHeight);
        }
